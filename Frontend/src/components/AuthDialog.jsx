...
export default function AuthDialog({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/70 backdrop-blur-md p-4">
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-[28px] border border-white/10 bg-[#0d0d11] text-white shadow-[0_40px_120px_rgba(0,0,0,0.55)] transition-all duration-300 ease-in-out" style={{ height }}>
        <div ref={contentRef}>
