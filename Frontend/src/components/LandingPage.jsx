...
/* ─── Feature cards ───────────────────────────────────────── */
const CARDS = [
  { title: 'Instant Execution',     desc: 'Seamless multi-runtime execution for JavaScript, Python, Java, and C.',
  ...
  { title: 'Grok AI Review',         desc: 'Enterprise-grade architecture, security, and performance analysis.',
  ...
  { title: 'Smart Versioning',       desc: 'Time-travel through code history with intelligent change analysis.',
  ...
  { title: 'AI Debug Mode',          desc: 'Identifies runtime errors and provides optimized solutions instantly.',
  ...
  { title: 'Persistent Workspace',   desc: 'Professional multi-file management with secure cloud persistence.',
